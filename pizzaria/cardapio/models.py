...
class TipoPizza(models.Model):
    ...
    descricao = models.TextField(blank=True) #TextField - Texto Longo
...
class IngredientePizza(models.Model):
    #Relaciona o ingrediente com a pizza que será criada
    ...
    def custo_ingrediente(self):
        return self.quantidade_numerica * self.ingrediente.preco_unidade
